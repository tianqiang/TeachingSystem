...
namespace TeachingSystem.Data
{
    public class NHibernateData
    {
        ...
        public SelectCourse GetSelectCourseDataByNum(string number)
        {
            return Session.Get<SelectCourse>(number);
        }
        ...
        public IList<SelectCourse> GetSelectCourse(string query)
        {
            return Session.CreateQuery(query).List<SelectCourse>();
        }
